...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-[48px] w-full items-center justify-between rounded-md border border-slate-700 bg-white px-4 py-5 text-base text-black placeholder:text-white focus:border-slate-900 outline-none",
      className
    )}
    {...props}
  >
